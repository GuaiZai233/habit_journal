...
func main() {
	...
	r.Put("/api/v1/logs/{date}", func(w http.ResponseWriter, r *http.Request) {
	...
	r.Post("/api/v1/sync/push", func(w http.ResponseWriter, r *http.Request) {
	...
	r.Get("/api/v1/sync/pull", func(w http.ResponseWriter, r *http.Request) {
